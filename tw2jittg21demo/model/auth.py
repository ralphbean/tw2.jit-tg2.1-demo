...
It's perfectly fine to re-use this definition in the tw2.jit-tg2.1-demo application,
though.
...
from tw2jittg21demo.model import DeclarativeBase, metadata, DBSession
